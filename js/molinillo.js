...
class WindPinwheel {
    ...
    draw() {
        ...
        this.ctx.translate(this.canvas.width / 2, this.canvas.height / 2 - this.poleHeight);
        ...
        for (let i = 0; i < 4; i++) {
            ...
            const color = `hsl(${(i * 90 + this.rotationAngle * (180 / Math.PI)) % 360}, 70%, 50%)`;
...
const windPinwheel = new WindPinwheel(document.getElementById("canvasMolinillo"), 50, 10, 100);