...
class Pong {
    constructor(canvas) {
        ...
        this.playerPaddle = new Paddle(10, canvas.height / 2 - 50, 10, 100, 'blue', 0);
        this.aiPaddle = new Paddle(canvas.width - 20, canvas.height / 2 - 50, 10, 100, 'green', 0);
        this.playerScore = 0;
        this.aiScore = 0;
    ...
    reset() {
        this.ball = new Ball(100, 100, 10, 'red', 5, 1, 1);
        this.playerPaddle = new Paddle(10, this.canvas.height / 2 - 50, 10, 100, 'blue', 0);
        this.aiPaddle = new Paddle(this.canvas.width - 20, this.canvas.height / 2 - 50, 10, 100, 'green', 0);
        this.gameRunning = false;
    }
    ...
    checkPaddleHit() {
        if (this.ball.x - this.ball.radius < this.playerPaddle.x + this.playerPaddle.width && this.ball.y > this.playerPaddle.y && this.ball.y < this.playerPaddle.y + this.playerPaddle.height && this.ball.directionX === -1) {
            this.ball.directionX = 1;
            return true;
        } else if (this.ball.x + this.ball.radius > this.aiPaddle.x && this.ball.y > this.aiPaddle.y && this.ball.y < this.aiPaddle.y + this.aiPaddle.height && this.ball.directionX === 1) {
            this.ball.directionX = -1;
            return true;
        }
        return false;
